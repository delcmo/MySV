...
SvMomentum::SvMomentum(const std::string & name, InputParameters parameters)
...
Real
SvMomentum::computeQpJacobian()
{
  return 0.;
}

Real
SvMomentum::computeQpOffDiagJacobian(unsigned int jvar)
{
  return 0.;
}